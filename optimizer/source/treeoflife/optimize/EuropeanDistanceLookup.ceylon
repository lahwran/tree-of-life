...
object europeanDistanceLookup satisfies DistanceLookup {
    value distances = HashMap<Gene, Map<Gene, Integer>>(15);

    // Distances are in km as the crow flies (from http://www.indo.com/distance/)

    value amsterdam = HashMap<Gene, Integer>(20);
    ...
    value athens = HashMap<Gene, Integer>(20);
    ...
    value berlin = HashMap<Gene, Integer>(20);
    ...
    value brussels = HashMap<Gene, Integer>(20);
    ...
    value copenhagen = HashMap<Gene, Integer>(20);
    ...
    value dublin = HashMap<Gene, Integer>(20);
    ...
    value helsinki = HashMap<Gene, Integer>(20);
    ...
    value lisbon = HashMap<Gene, Integer>(20);
    ...
    value london = HashMap<Gene, Integer>(20);
    ...
    value luxembourg = HashMap<Gene, Integer>(20);
    ...
    value madrid = HashMap<Gene, Integer>(20);
    ...
    value paris = HashMap<Gene, Integer>(20);
    ...
    value rome = HashMap<Gene, Integer>(20);
    ...
    value stockholm = HashMap<Gene, Integer>(20);
    ...
    value vienna = HashMap<Gene, Integer>(20);
